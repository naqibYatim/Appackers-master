...
import com.example.ash.appackers.adapters.ChatMessageRecyclerAdapter;
import com.example.ash.appackers.models.ChatMessage;
import com.example.ash.appackers.models.Chatroom;
import com.example.ash.appackers.models.UserLocation;
import com.example.ash.appackers.ui.UserListFragment;
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@javax.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @javax.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        if(queryDocumentSnapshots != null){
                            ...
                            // User object might needed changed
                            for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
